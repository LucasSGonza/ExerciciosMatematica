...
public class Exercicio2 {
    ...
    public static void main(String[] args) {
        ...
        if (delta > 0) {
            ...
            System.out.println("A equação de segundo grau acima possuí 2 raízes reais exatas pois o delta é maior que zero!");
            ...
            raizDelta = 0;
            System.out.println("A equação de segundo grau acima possuí 1 raíz real exatas pois o delta é igual a 0!");
            bhaskara1 = ((b - b - b) + raizDelta) / (2 * a);
            System.out.println("A raíz real da equação é: " + bhaskara1);

        } else if (delta < 0) {
            System.out.println("A equacao de segundo grau acima nao possui raizes reais exatas pois o delta é negativo!");
        }
